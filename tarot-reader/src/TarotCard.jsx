...
function TarotCard({ position, name, image, isFlipped, isReversed, isCrossing, meaning, meaningReversed }) {
  const cardBack = "./images/card_back.png";

  return (
    
    <div className={`tarot-card ${isFlipped ? 'is-back' : ''} ${isReversed ? 'reversed' : ''} ${isCrossing ? 'is-crossing' : ''}`}>
      {!isFlipped && position && (
